...
public class KanjiUtils {
	...
	private static final String jlpt[] = {
		// N1
	...
	public static String getJlpt(String kanji) {
		
		if (kanji == null) {
			return null;
		}
		
		for (int idx = 0; idx < jlpt.length; ++idx) {
			String currentJlpt = jlpt[idx];
			
			if (currentJlpt.contains(kanji) == true) {
				return "JLPT " + (idx + 1);
			}
		}
