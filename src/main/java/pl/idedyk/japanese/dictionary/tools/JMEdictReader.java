...
public class JMEdictReader {
	...
	public static TreeMap<String, EDictEntry> readJMEdict(String fileName) throws Exception {
		...
		DefaultHandler handler = new DefaultHandler() {
			...
			private EDictEntry edictEntry = null;
			...
			public void characters(char[] ch, int start, int length) throws SAXException {
				...
				if (currentStack.equals("JMdict entry sense pos") == true) {
					...
					edictEntry.getPos().add(entityMapper.getEntity(pos));
				}
			}
