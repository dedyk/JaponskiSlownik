...
public class KanaHelper {
	...
	public static List<KanaEntry> getAllHiraganaKanaEntries() {
		...
		hiraganaEntries.add(new KanaEntry("ぢゃ", "dya"));
	...
	public static KanaWord convertRomajiIntoHiraganaWord(Map<String, KanaEntry> hiraganaCache, String word)
	...
	public static KanaWord convertRomajiIntoKatakanaWord(Map<String, KanaEntry> kitakanaCache, String word)
			throws JapaneseDictionaryException {
	...
	public static KanaWord convertKanaStringIntoKanaWord(String kana, List<KanaEntry> hiraganaEntries,
			List<KanaEntry> kitakanaEntries) {
