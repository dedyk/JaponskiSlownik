...
public class GenkiBookWords {
	...
	private static List<PolishJapaneseEntry> generateWords(List<PolishJapaneseEntry> polishJapaneseEntries) {
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_2, "kokuban", "tablica", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_2, "bideo", "video", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_2, "kaaten", "zasłonka", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_2, "doa", "dzwi", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_2, "keshigomu", "gumka", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_2, "isu", "krzesło", null);
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_3, "yoku", new String[] { "często", "wiele" }, null);
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_5, "chiisai", "mały", "i-przymiotnik");
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_6, "yukkuri", new String[] { "powoli", "wolno", "bez pośpiechu" }, null);
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_6, "migi ni magaru", "skręcić w prawo", null);
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_7, "se", "wzrost", null);
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_7, "benri", "przydatny", "na-przymiotnik");
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_7, "ni sumu", "mieszkać", "u-czasownik");
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_7, "ni tsutomeru", "pracować dla", "ru-czasownik");
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_7, "nanimo", "nie ... cokolwiek", "+ forma negatywna");
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "asatte", "po jutrze", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "ame", "deszcz", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "kaishain", "pracownik biurowy", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "kamera", "kamera", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "kuuki", "powietrze", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "kesa", "dzisiejszy poranek", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "kongetsu", "aktualny miesiąc", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "shigoto", "praca", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "daigakusei", "student", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "deisuko", "dyskoteka", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "tenkiyohou", "prognoza pogody", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "tokoro", "miejsce", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "tomato", "pomidor", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "natsu", "lato", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "nani ka", "coś", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "paateii", "party", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "baabekyuu", "brill", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "hashi", "pałeczki", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "fuya", "zima", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "hoomesutei", new String[] { "pozostać w domu", "żyć ze swoją lokalną rodziną" }, null);
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "maishuu", "w każdym tygodniu", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "raigetsu", "w następnym tygodniu", null);
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "ga jouzu", "dobry w", "na-przymiotnik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "ga heta", "słaby w", "na-przymiotnik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "yuumei", "sławny", "na-przymiotnik");
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "ame ga furu", "pada deszcz", "u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "arau", "myć", "u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "iu", "mówić", "u-czasownik");
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "ga iru", "potrzebować", "u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "ni osokunaru", "być spóźniony", "na, u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "omou", "myśleć", "u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "kiru", "ciąć", "u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "tsukuru", "tworzyć", "u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "motteiku", "brać", "coś, u-czasownik");
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "o jirojiromiru", "spojrzeć", "ru-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "hajimeru", "zaczynać", "ru-czasownik");

		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "o unten suru", "prowadzić", "czasowniki nieregularne");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "sentaku suru", "robić pranie", "czasownik nieregularny");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "souji suru", "czyścić", "czasownik nieregularny");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "ryouri suru", "gotować", "czasownik nieregularny");
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "uun", "nie", "u...");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "un", "tak", "u...");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "kanpai", "na zdrowie", "toast");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "zannen desu ne", "trudno", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "mada", "jeszcze nie", "+ forma negatywna");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "minna", "wszyscy", null);
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "iiko", "dobre dziecko", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "iro", "kolor", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "obentou", "pudełko na jedzenie", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "onsen", "gorące źródło", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "kabuki", "Kabuki", "tradycyjny Japoński teatr");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "gitaa", "gitara", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "kusuri", "lekarstwo", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "kusuri o nomu", "brać lekarstwo", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "konseeto", "koncert", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "kondo", "następnym razem", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "sakubun", "wypracowanie", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "shiken", "egzamin", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "shinkansen", "Shinkansen", "szybka kolej");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "sukii", "narty", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "sengetsu", "poprzedni miesiąc", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "tango", "słownictwo", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "piano", "pianino", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "byouki", "choroba", null);
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "aoi", "niebeski", "i-przymiotnik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "akai", "czerwony", "i-przymiotnik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "kuroi", "czarny", "i-przymiotnik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "sabishii", "samotny", "i-przymiotnik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "shiroi", "biały", "i-przymiotnik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "wakai", "młody", "i-przymiotnik");
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "ijiwaru", "złośliwy", "na-przymiotnik");

		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "odoru", "tańczyć", "u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "ga owaru", "kończyć", "u-czasownik, coś");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "ninki ga aru", "być popularny", "u-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "ga hajimaru", "rozpoczynać", "u-czasownik, coś");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "hiku", "grać", "u-czasownik, instrument klawiszowy");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "tataku", "grać", "u-czasownik, na bębnie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "fuku", "grać", "u-czasownik, instrument dmuchany");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "o morau", "dostać", "u-czasownik, coś, osoba ni rzecz");
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "oboeru", "zapamiętać", "ru-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "ni deru", "pojawić się", "ru-czasownik");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "o deru", "wychodzić", "ru-czasownik");

		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "undou suru", "ćwiczenia", "czasownik nieregularny, fizyczne");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "sanpo suru", "spacerować", "czasownik nieregularny");
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "kara", "od", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "zehi", "koniecznie", null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_9, "tokorode", "przy okazji", null);
	...
	private static List<PolishJapaneseEntry> generateKanjiWords(List<PolishJapaneseEntry> polishJapaneseEntries) {
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "員", new String[] { "in" }, new String[] { "członek" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "新", new String[] { "atara", "shin" }, new String[] { "nowy" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "聞", new String[] { "ki", "bun" }, new String[] { "słuczać" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "作", new String[] { "tsuku", "saku" }, new String[] { "tworzyć", "robić" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "仕", new String[] { "shi" }, new String[] { "służyć" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "事", new String[] { "goto", "koto", "ji" }, new String[] { "rzecz" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "電", new String[] { "den" }, new String[] { "elektryczność" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "車", new String[] { "kuruma", "sha" }, new String[] { "samochód" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "休", new String[] { "yasu", "kyuu" }, new String[] { "odpoczywać" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "言", new String[] { "i", "gen" }, new String[] { "mówić" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "読", new String[] { "yo", "doku" }, new String[] { "czytać" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "思", new String[] { "omo", "shi" }, new String[] { "myśleć" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "次", new String[] { "tsugi", "ji" }, new String[] { "następny" }, "czytanie");
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "何", new String[] { "nani", "nan" }, new String[] { "co" }, "czytanie");
		...
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "仕事", new String[] { "shigoto" }, new String[] { "praca" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "事", new String[] { "koto" }, new String[] { "rzecz" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "火事", new String[] { "kaji" }, new String[] { "ogień" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "食事", new String[] { "shokuji" }, new String[] { "posiłek" }, null);
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "電車", new String[] { "densha" }, new String[] { "pociąg" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "電気", new String[] { "denki" }, new String[] { "elektryczność" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "電話", new String[] { "denwa" }, new String[] { "telefon" }, null);
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "車", new String[] { "kuruma" }, new String[] { "samochód" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "電車", new String[] { "densha" }, new String[] { "pociąg" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "自転車", new String[] { "jitensha" }, new String[] { "rower" }, null);

		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "休む", new String[] { "yasumu" }, new String[] { "być nieobecny", "odpoczywać" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "休み", new String[] { "yasumi" }, new String[] { "wakacje", "nieobecny" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "休日", new String[] { "kyuujitsu" }, new String[] { "wakacje" }, null);

		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "言う", new String[] { "iu" }, new String[] { "mówić" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "言語学", new String[] { "gengogaku" }, new String[] { "lingwistyka" }, null);
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "読む", new String[] { "yomu" }, new String[] { "czytać" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "読書", new String[] { "dokusho" }, new String[] { "czytać książki" }, null);

		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "思う", new String[] { "omou" }, new String[] { "myśleć" }, null);
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "不思議な", new String[] { "fushigina" }, new String[] { "tajemniczy" }, null);
		
		addPolishJapaneseEntry(polishJapaneseEntries, DictionaryEntryType.WORD_GENKI1_8, "次", new String[] { "tsugi" }, new String[] { "następny" }, null);
