...
public class SetEntryToPolishDictionary {
	...
	public static void main(String[] args) throws Exception {
		...
		dictionaryHelper.saveEntryListAsHumanCsv(saveEntryListAsHumanCsvConfig,  "input/word2-test01-new.csv", dictionaryHelper.getAllPolishDictionaryEntryList(), new EntryAdditionalData());
	}
